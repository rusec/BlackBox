 ...
 */
function generatePasses(length, seeder) {
    const rng = random_seed_1.default.create((0, keccak256_1.default)(seeder + "shrimp_key").toString("hex"));
    const results = [];
...
exports.generatePasses = generatePasses;
